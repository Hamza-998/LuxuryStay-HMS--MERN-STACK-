...
(async () => {
    try {
        console.log("Generating styled DOCX...");
        const docBuffer = await HTMLtoDOCX(htmlString, null, {
        ...
        const outputPath = 'C:/Users/Talha/Pictures/LuxuryStay-HMS/LuxuryStay_Hospitality_HMS_Project_Documentation_V2.docx';
        fs.writeFileSync(outputPath, docBuffer);
        console.log("Styled DOCX successfully generated at " + outputPath);
    } catch (err) {
