...
const diagrams = {
    '1_System_Architecture.txt': `\`\`\`mermaid
graph TD
...
\`\`\``,
    ...
    '3_Use_Case.txt': `\`\`\`mermaid
usecaseDiagram
    actor Admin
    actor Guest
    actor Staff
    
    package "LuxuryStay Hotel Management System" {
        %% Admin Use Cases
        usecase "View Dashboard & Analytics" as UC1
        usecase "Manage Room Inventory" as UC2
        usecase "Manage Users & Staff Roles" as UC3
        usecase "Assign Maintenance/Cleaning Tasks" as UC4
        usecase "Manage All Reservations" as UC5
        ...
        usecase "Book Room (Select Dates)" as UC8
        usecase "View Personal Booking History" as UC9
        usecase "Request Room Services" as UC10
        usecase "Submit Feedback/Reviews" as UC11
        ...
        usecase "View Assigned Housekeeping Tasks" as UC13
        usecase "Update Task Status (In Progress/Resolved)" as UC14
...
\`\`\``,
    ...
    '5_Complete_Workflow.txt': `\`\`\`mermaid
sequenceDiagram
    autonumber
    actor Guest
...
console.log("All diagram files rewritten successfully!");
